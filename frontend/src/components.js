  ...
  const renderMainContent = () => {
    switch (currentSection) {
      ...
      case 'business-prototype':
        return <BusinessPrototypeSection currentIdea={currentIdea} onNavigate={handleSectionChange} />;
      case 'lean-canvas-details':
        return <LeanCanvasDetailsSection currentIdea={currentIdea} onNavigate={handleSectionChange} />;
      case 'validation':
...
// Business Prototype Section - Updated to navigate to details page
const BusinessPrototypeSection = ({ currentIdea, onNavigate }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button 
            onClick={() => onNavigate('lean-canvas-details')}
        ...
        <div className="grid grid-cols-5 gap-4 mb-6">
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4">
            ...
            <div className="space-y-2">
              {leanCanvas.solutions?.features?.slice(0, 2).map((feature, index) => (
                <div key={index} className="text-xs text-green-800">• {feature}</div>
          ...
          <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-4">
            ...
            <div className="text-xs text-purple-800 font-medium">{leanCanvas.valueProposition?.substring(0, 50)}...</div>
          </div>

          <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-4">
            <h3 className="font-semibold text-orange-900 mb-3 text-sm">J. Unfair Advantage</h3>
            <div className="text-xs text-orange-800">{leanCanvas.unfairAdvantage?.substring(0, 40)}...</div>
          </div>

          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4">
            <h3 className="font-semibold text-red-900 mb-3 text-sm">A. Customer Segments</h3>
            <div className="space-y-1">
              {leanCanvas.customerSegments?.slice(0, 3).map((customer, index) => (
                <div key={index} className="text-xs text-red-800">• {customer.name || customer}</div>
        ...
        <div className="grid grid-cols-5 gap-4">
          ...
          <div className="bg-teal-50 border-2 border-teal-200 rounded-lg p-4">
            ...
            <div className="space-y-1">
              {leanCanvas.competitors?.direct?.slice(0, 3).map((competitor, index) => (
                <div key={index} className="text-xs text-teal-800">• {competitor}</div>
              )) || leanCanvas.competitors?.slice(0, 3).map((competitor, index) => (
                <div key={index} className="text-xs text-teal-800">• {competitor}</div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-indigo-50 border-2 border-indigo-200 rounded-lg p-4">
            ...
            <div className="space-y-1">
              <div className="text-xs text-indigo-800">• Early tech adopters</div>
              <div className="text-xs text-indigo-800">• Industry professionals</div>
            </div>
          </div>
          ...
          <div className="bg-pink-50 border-2 border-pink-200 rounded-lg p-4">
            ...
            <div className="space-y-1">
              {leanCanvas.costStructure?.slice(0, 2).map((cost, index) => (
                <div key={index} className="text-xs text-pink-800">• {cost}</div>
              ))}
            </div>
          </div>
        </div>
